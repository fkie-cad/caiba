...
enum CAN_XR_MAC_RX_FSM_State
{
    ...
    CAN_XR_MAC_RX_FSM_ERROR_FLAG,
    CAN_XR_MAC_RX_FSM_ERROR_DEL
};
...
enum CAN_XR_MAC_TX_FSM_State
{
    ...
    CAN_XR_MAC_TX_FSM_TX_DATA_MAC,  // for two bytes of message authentication code
...
struct CAN_XR_MAC_State
{
    ...
    uint32_t rx_identifier; /* Buffers for reassembled frame */ // INFO: identifier of the received frame
    int rx_rtr;
    int rx_ide;
    int rx_fdf;
    int rx_dlc;
...
typedef void (* CAN_XR_MAC_Data_Req_t)(
    ...
    uint32_t identifier,
    enum CAN_XR_Format format, int dlc, uint8_t *data, uint8_t *data_mac);
