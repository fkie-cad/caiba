...
/* PMA primitive invoked upon each node clock edge to check for a new
 * frame to transmit. Arguments are the target PCS data structure. It
 * shall return if a new message should be transmitted or not.
 */
typedef int (* CAN_XR_PMA_App_NodeClock_Ind_t)(
...
struct CAN_XR_PMA_GPIO_State
{
    ...
    */
    CAN_XR_PMA_App_NodeClock_Ind_t app_nodeclock_ind;
};
